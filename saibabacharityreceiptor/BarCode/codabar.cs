...
namespace saibabacharityreceiptor.BarCode
{
    public class Codabar : Barcode
    {
        ...
        public override KeyCode[] Keys
        {
            get
            {
                return Utilities.MergeKeyCode(Utilities.KeyCodeNumber, new KeyCode('-'), new KeyCode('$'), new KeyCode(':'), new KeyCode('/'), new KeyCode('.'), new KeyCode('+'), new KeyCode('A'), new KeyCode('B'), new KeyCode('C'), new KeyCode('D'));
            }
        }
    }
}