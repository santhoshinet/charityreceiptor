...
<body onload="javascript:window.print();">
    <div class="container">
        ...
        <div class="data">
            <ul>
                <li class="one"><span class="field">Goods received:</span><span class="value"><%= receptData.MerchandiseItem %></span></li>
            </ul>
        </div>
        <div class="clear">
        </div>
        <div class="data">
            <ul>
                <li class="one"><span class="field">Goods FMV in USD:</span><span class="value"><%= receptData.FmvValue %></span></li>
            </ul>
        </div>
        <div class="clear">
        </div>
